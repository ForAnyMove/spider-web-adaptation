...
const trialLevelDatabase = {
    ...
    levels: [
        ...
        createTrialLevel(5, LevelType.Trial, LevelState.Locked, Rule.TwoSuitsSpiderLady, { items: [createItem(Items.Energy, 5)] }, 1200, createDeckTrial(2)),
        createTrialLevel(6, LevelType.Trial, LevelState.Locked, Rule.TwoSuitsSpider, { items: [createItem(Items.Energy, 5)] }, 1200, createDeckTrial(4)),
        createTrialLevel(7, LevelType.Trial, LevelState.Locked, Rule.TwoSuitsSpiderLady, { items: [createItem(Items.Energy, 5), createItem(Items.Trophy01, 1)] }, 1200, createDeckTrial(1)),
        createTrialLevel(8, LevelType.Trial, LevelState.Locked, Rule.TwoSuitsSpiderLady, { items: [createItem(Items.Energy, 5)] }, 1200, createDeckTrial(6)),
        createTrialLevel(9, LevelType.Trial, LevelState.Locked, Rule.FourSuitsSpiderLady, { items: [createItem(Items.Energy, 5), createItem(Items.Trophy02, 1)] }, 1200, createDeckTrial(2)),
        createTrialLevel(10, LevelType.Trial, LevelState.Locked, Rule.FourSuitsSpider, { items: [createItem(Items.Energy, 5)] }, 1200),
        createTrialLevel(11, LevelType.Trial, LevelState.Locked, Rule.FourSuitsSpiderLady, { items: [createItem(Items.Energy, 5), createItem(Items.Trophy03, 1)] }, 1200),
        createTrialLevel(12, LevelType.Trial, LevelState.Locked, Rule.FourSuitsSpider, { items: [createItem(Items.Energy, 5)] }, 1200, createDeckTrial(2)),
